package cn.yang.security.crypto.password;
...
/**
 * A {@link org.springframework.security.crypto.password.PasswordEncoder} implementation that uses PBKDF2 with :
 * <ul>
...
public class Pbkdf2PasswordEncoder implements PasswordEncoder {
    ...
    private String algorithm = SecretKeyFactoryAlgorithm.PBKDF2_WITH_HMAC_SM3.getAlgorithmName();
    ...
    public enum SecretKeyFactoryAlgorithm {
        ...
        PBKDF2_WITH_HMAC_SM3("PBKDF2withHmacSM3");
        ...
        SecretKeyFactoryAlgorithm(String algorithmName) {
